...
import { getMatchInfo, getPlayerDesc, getPlayerStat } from "../api/api";
    ...
    <div className={classes.root}>
      <Accordion>
        ...
        <div className="prof__details">
            ...
            <div className = "prof__statsBatting">
              <div className = "prof__statBattingFo rmatInfo">
...
function PlayerSearch() {
    ...
    useEffect(() => {
        if(search !== ''){
            ...
            .then((player) => {setPlayers(player.data)
    ...
    useEffect(() => {
        getMatchInfo()
        .then((data) => {setMatches(data.matches.slice(0,5))
            //console.log(data);
        })
        .catch((err) => {console.log(err)})
    }, []);
